...
const _init = async () => {
    const channel = client.channels.cache.find(channel => channel.name === "storage-provider");
...
const getSizeFromJoystream = async () => {
    return axios.get('https://analytics.dapplooker.com/api/public/dashboard/c70b56bd-09a0-4472-a557-796afdc64d3b/card/155?parameters=%5B%5D')
        .then((response) => {
            // handle success
...
client.on('message', async (msg) => {
    ...
    if (msg.content === '/storagesize') {
        msg.reply("Calculating... <a:check_no:717523612906684428>")
